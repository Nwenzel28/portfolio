...
const portfolios = [
...

  {
    ...
    students: [
      ...
      { name: "Travis Dumaran", link: "https://sites.google.com/punahou.edu/orangesarethebest/home" },
      { name: "Tenuun Batdelger", link: "https://sites.google.com/punahou.edu/secrettunneltype/home" },
      { name: "Kai Gammarino", link: "https://sites.google.com/punahou.edu/kaiengineeringportfolio/home" },
      { name: "Kekoa Ratchaworapong", link: "https://sites.google.com/punahou.edu/kekoadteprofile/home" },
      { name: "Noah Shin", link: "https://sites.google.com/punahou.edu/noahshinsengineeringportfolio/home" },
      { name: "Micah Shimozono", link: "https://sites.google.com/punahou.edu/micahshimozono-engineering" },
      { name: "Isiah Hirota", link: "https://sites.google.com/punahou.edu/ihirota28engineering/home" },
...
const numberFacts = [
  ...
  { number: 4, fact: "Lowest single-digit interstate highway number." },
  { number: 5, fact: "Lowest interstate major highway number." },
  { number: 7, fact: "Number of unique letters in 'thealphabet' (thealpb)." },
  { number: 8, fact: "Number of semesters in high school." },
  { number: 11, fact: "Lowest multi-digit whole number palindrome." },
  { number: 12, fact: "Dozen." },
  { number: 13, fact: "Baker's dozen." },
  { number: 17, fact: "Games played per team in an NFL season." },
  { number: 24, fact: "Number of checker pieces on a board." },
  { number: 26, fact: "Letters in the alphabet." },
  { number: 28, fact: "My graduation year abbreviation." },
  { number: 32, fact: "Number of chess pieces on a board." },
  ...
  { number: 80, fact: "Days needed to travel around the world by Phileas Fogg. Or was it 79?" },
  { number: 81, fact: "The inverse repeats all 10 digits in order." },
  { number: 86, fact: "Number of metals on the periodic table." },
  { number: 94, fact: "94! - 1 is prime." },
  { number: 98, fact: "Reciprocal decimal form resembles powers of two (0.01020408163265306122448979)." },
  { number: 145, fact: "One of four numbers equal to the sum of their digits' factorials." },
  { number: 365, fact: "Standard days in a year." },
  { number: 990, fact: "Highest interstate highway number." },
  { number: 999, fact: "Last number before 1,000,000 without an 'a' in it." },
  { number: 1000, fact: "Smallest whole number with an 'a' in it." },
  { number: 1138, fact: "Part of the title of George Lucas' first film; referenced in Star Wars." },
  { number: 2340, fact: "Approximate number of school days from K-12." },
